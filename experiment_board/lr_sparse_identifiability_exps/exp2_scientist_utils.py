...
class IdentifiabilityStudyExp2(ExperimentBase):
    def execute(self, sub_experiment_name,
        ...
        if sub_experiment_name == 'a':
            return self.execute_exp_a(resolution, n_repeat, seed_start, devices)
        elif sub_experiment_name == 'b':
            return self.execute_exp_b(resolution, n_repeat, seed_start, devices)
        

    def execute_exp_a(self, resolution,
